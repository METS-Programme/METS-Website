            ...
            <div class="eo_s2_box">   
                <div id="<?php echo $id . '_' . $eo_index. "_eo_image" ?>" class="event_img_s2" style="background-image:url(<?php echo $item_array[4] ?>);">
                        <div class="box_overlaybox">
                          <div class="eo_s2_prebutton_open"><div class="eo_s2_button_open" onclick="showEventOESAinit('<?php echo $eo_index ?>','<?php echo $id; ?>',<?php echo $id. "_eo_js_array"; ?>,'<?php echo $open_type ?>')"><?php echo $lan_arr_eosa["open_event"]; ?></div></div> 
                        </div> 
                ...
                <div class="eo_s2_downbox">
                    <div class="eo_s2_row" <?php echo printPopCode($id, $id . '_' . $eo_index. "_eo_boxlocation",$eo_index,$item_array[5]) ?> onclick="showMapEOSA('<?php echo $item_array[5] . "','" . $id; ?>')">
                        <span class="eo_icon_box_2"><i class="fa fa-map-marker"></i></span>
                        <span class="so_title overflow_box" id="<?php echo $id . '_' . $eo_index. "_eo_location" ?>"><?php echo $item_array[5]; ?></span>
                    </div>
...
<div class="<?php echo $skin ?>"><div class="eosa_fulllist_box <?php echo $skin ?>" id="<?php echo $id; ?>_eosa_fulllist_box"></div></div>