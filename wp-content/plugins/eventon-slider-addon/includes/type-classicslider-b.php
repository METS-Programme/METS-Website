            ...
            <li>
                <div class="eo_s1b_box">
                    <div class="s1b_img <?php if ($details == "no") { echo "s1300"; } else { if (strlen($item_array[3]) == 0) echo "s1345"; else echo "s1300"; } ?>" style="background-image:url(<?php echo $item_array[4]; ?>);">
                        ...
                        <?php if(strlen($item_array[6]) > 0) { ?><div class="s1b_organizer oflow"><i class="fa fa-headphones" style="color: #<?php echo $item_array[10]; ?>"></i><?php echo $lan_arr['evcal_lang_evorg'] . " " . $item_array[6]; ?></div><?php } ?>
                    </div>
                        ...
                        <div class="s1b_box_a">
                            <div class="s1b_datetime_box <?php if ($details == "no") echo "nocontent" ?>">
                                <div class="s1b_colb oflow" <?php echo printPopCode($id, $id . '_' . $eo_index. "_eo_boxlocation",$eo_index,$item_array[5]) ?>><div class="overflow_box" style="padding-right: 5px;"><i class="fa fa-map-marker" style="color: #<?php echo $item_array[10]; ?>"></i><?php echo $item_array[5]; ?></div></div>
                                <div class="s1b_colb oflow" <?php echo printPopCode($id, $id . '_' . $eo_index. "_eo_boxtime",$eo_index,$item_array[8]) ?>><div class="overflow_box"><i class="fa fa-clock-o" style="color: #<?php echo $item_array[10]; ?>"></i><?php echo $item_array[8]; ?></div></div>
                            ...
                            <?php if($details == "yes") { ?> <p class="s1b_desc"><?php echo $item_array[7]; ?></p><?php } ?>
                            <div class="s1b_button_box">
                                 <?php if($map == "yes") { ?><div class="s1b_button" onclick="showMapEOSA('<?php echo $item_array[5]; ?>','<?php echo $id; ?>')"><?php echo $lan_arr_eosa["show_map"]; ?></div><?php } ?>
