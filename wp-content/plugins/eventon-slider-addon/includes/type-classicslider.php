            ...
            <li>
                <div class="eo_s1_box">
                        ...
                        <div class="eo_s1_details_box">
                            <div class="eo_left_x1">
                                <div class="eo_s1_tbox">
                                    ...
                                    <p class="eo_s1_t2">
                                        <i class="fa fa-headphones eo_i" style="color: #<?php echo $item_array[10]; ?>"></i><?php echo $lan_arr['evcal_lang_evorg'] ?><span class="eo_s1_t2b" id="<?php echo $id . '_' .   $eo_index. "_eo_organizer" ?>">
                    ...
                    <div class="eo_s1_downbox">
                        <div class="s1_in s1_left" <?php echo printPopCode($id, $id . '_' . $eo_index. "_eo_boxlocation",$eo_index,$item_array[5]) ?>>
