...
<div class="flexslider_event eosa_minicarousel <?php echo $skin ?>">
        ...
        <ul class="slides">
          ...
          while(have_posts()):
              ...
              // MIKE
              // push $row_txt to item_array index 17
              array_push($item_array,$row_txt);
              ...
              foreach($arrRepeats as $item_array) {
                  ...
                  // MIKE
                  // push $row_txt to item_array index 18
                  array_push($item_array,$row_txt);
                  // push $row_html to item_array index 19
                  array_push($item_array,$row_html);
              }
          ...
          endwhile;  wp_reset_query();                             
            ...
            <li>
                ...
                <div id="<?php echo $fullid ?>" class="eo_s3b_box <?php if ($mcar_image=="yes") echo "eo_s3b_img"; else echo "eo_s3b_noimg"; ?>" onclick="showEventOESAinit('<?php echo $eo_index ?>','<?php echo $id; ?>',<?php echo $id. "_eo_js_array"; ?>,'<?php echo $open_type ?>','<?php echo $c_dir ?>','<?php echo $fullid ?>')"> 
                    <div class="eo_s3b_box0" style="border-top: 1px solid #<?php echo $item_array[10]; ?>">
                        ...
                        <div class="row_s3b_box1">
                            <div class="eo_s3b_row2" <?php echo printPopCode($id, $id . '_' . $eo_index. "_eo_boxtitle",$eo_index,$item_array[2]) ?> style="color: #<?php echo $item_array[10]; ?>"><div class="overflow_box"><?php echo $item_array[2]; ?></div></div>
                            <hr />
                            <div class="eo_s3b_row3" <?php echo printPopCode($id, $id . '_' . $eo_index. "_eo_boxrow2",$eo_index,$item_array[18]) ?>><div class="overflow_box"><?php echo $item_array[19]; ?></div></div>
                        </div>
                    </div>
