        ...
        <li>
            ...
            <div class="eo_card_box">
                ...
                <div class="eo_card_downbox">
                    <div class="eo_card_row eo_over" <?php echo printPopCode($id, $id . '_' . $eo_index. "_eo_boxlocation",$eo_index,$item_array[5]) ?>  onclick="showMapEOSA('<?php echo $item_array[5] . "','" . $id; ?>')">
                        <i class="fa fa-map-marker" style="color: #<?php echo $item_array[10] ?>"></i>
                        <span class="eo_card_sotitle overflow_box" id="<?php echo $id . '_' . $eo_index. "_eo_location" ?>"><?php echo $item_array[5]; ?></span>
                    </div>
